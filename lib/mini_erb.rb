...
class MiniErb
  ...
  # The optional filename passed to Kernel#eval when the mini_erb code is run.
  attr_accessor :filename

  # The optional lineno passed to Kernel#eval when the mini_erb code is run.
  attr_accessor :lineno

  # Set the file name and optional line number associated with this code.
